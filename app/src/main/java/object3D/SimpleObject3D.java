...
public class SimpleObject3D {
    private final String TAG = "SIMPLEOBJECT3D";
    Context context;
    int resourceID;
    ...
    public SimpleObject3D(Context context, int program, int resourceID, Vertex3D position, Vector3D angle, float red, float green, float blue, float alpha){
